...
const KanbanColumn = ({ column, tickets, placeholder }) => {
  ...
  return (
    <div
      ref={setNodeRef}
      className={`flex h-full w-[252px] flex-shrink-0 flex-col overflow-hidden rounded-2xl border bg-[#161b22] shadow-lg shadow-black/20 transition-colors duration-200 ${
