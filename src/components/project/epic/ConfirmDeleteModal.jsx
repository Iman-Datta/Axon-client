// components/project/epic/ConfirmDeleteModal.jsx
import { AlertTriangle, X } from "lucide-react";

function ConfirmDeleteModal({ epic, onCancel, onConfirm, loading, error }) {
  return (
    <div
      ...
      >
        ...
        <div className="px-5 py-5">
          <p className="text-sm text-[#c9d1d9]">
            ...
            <span className="font-semibold text-[#e6edf3]">"{epic?.name}"</span>
            ? This will permanently remove the epic
            {epic?.ticket_count > 0 ? " and unlink its tickets" : ""}. This
